...
import pages.US13_14.ViceDeanMngPage;

import pages.US_03_04.SametPage04;
import utilities.ReusableMethods;
import utilities.WaitUtils;

public class US_13_ViceDeanCreateTeacher {
    ...
    @And("Kullanici User Name girer {string}")
    public void kullaniciUserNameGirer(String string) {
        scholl.userName.sendKeys("Ilyas.Cnz");
    }

    @And("Kullanici Password girer {string}")
    public void kullaniciPasswordGirer(String string) {
        scholl.password.sendKeys("03122009Fb");
    }
}
